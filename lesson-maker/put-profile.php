...
if ($newcontent['email']) {
  ...
  $projectupdate = $mysqli->prepare("update class set project_description = ?, getforumemail = ? where student_email = ? and syllabus_syllabus_id = ?");
  $projectupdate->bind_param('siss',$newcontent['project_description'],$newcontent['emailflag'],$newcontent['email'],$newcontent['syllabus_id']);
