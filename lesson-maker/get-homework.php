...
$selecthomeworks = $mysqli->query('select  h.homework_id,e.description, weight, due_date as sortdate, 
...
where l.syllabus_syllabus_id='.$_GET["syllabus_id"].' and e.private = 0 order by sortdate');
$i = 0;
