  ...
  <tr>
    ...
    <div class="row">
      <h3  contenteditable="true" id="lesson-topic"></h3>
       ...
       <h4>Class Note Slides</h4>
       <textarea columns=300 rows=20 id="inputSlides" name="inputSlides" ></textarea>
       <h4>Weekly WrapUp</h4>
        <textarea columns=300 rows=20 id="inputWrapup" name="inputWrapup" ></textarea>
